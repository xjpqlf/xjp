...
import ui.zlz.R;
import ui.zlz.adapter.MyAdapters;
...
public class MyDialog {
    ...
    private MyAdapters mAdapter;                     //Adapter，设配自定义的数据
    ...
    public MyDialog setListView(List<String> list, AdapterView.OnItemClickListener listener) {
        ...
        mAdapter = new MyAdapters(mContext, R.layout.string_item_layout, mDataList);
        return this;
    }
    ...
    public MyDialog setListView(List<String> list, List<Integer> colors, AdapterView.OnItemClickListener listener) {
        ...
        mAdapter = new MyAdapters(mContext, R.layout.string_item_layout, mDataList, colors);
        return this;
    }
