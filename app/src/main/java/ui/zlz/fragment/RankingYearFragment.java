...
public class RankingYearFragment extends BaseFragment {
    ...
    protected int setContentView() {
        return R.layout.fragment_ranking_year;
    }
    ...
    protected void initData() {
        refreshLayout = findViewById(R.id.sr_rank_year);
        lv = findViewById(R.id.lv_rank_year);
