...
public class FriendFragment extends BaseFragment {
    ...
    protected void initData() {
        refreshLayout = findViewById(R.id.refreshLayout_icome);
        listView = findViewById(R.id.lv_income);
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        try {
                            ...
                            if ("1".equals(js.getString("code"))){
                                ...
                                FriendAdapter  adapter=new FriendAdapter(getActivity(),list2);
